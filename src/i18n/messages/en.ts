...
export const en = {
  ...
  terms: {
    ...
    s4Body:
      "Once UVELBox or UVELRack is activated, the purchase is final. Available tasks and earnings may decrease over time; see the risk disclosure. Purchased devices may be traded in. Credit can change, so review the current quote before checkout.",
  ...
  login: {
    ...
    serverSessionReloadNotice: "Sign in again after refreshing to access your account data.",
  },
  register: {
  ...
  home: {
    ...
    poolThisWeek: "This week’s pool",
    poolShare: "{n}% share",
    poolV3Unlock: "Not participating yet",
    ...
    productTrustWarranty: "Warranty",
    productTrustUnavailable: "Information unavailable",
    productTrustEmpty: "No available product to show",
    productTrustOpen: "View product",
    ...
    dayOneTaskSeeRoi: "View UVELBox S1 details",
  ...
  earn: {
    ...
    reconnectHold: "Reconnecting · Task cancels in {s}s",
    ...
    phonePausedNoNetworkHint: "Connect to Wi-Fi or mobile data to continue.",
    phoneSettingsTitle: "Background mode",
    phoneRequirementsHint: "Run with at least 20% battery and a network connection. Charging is optional.",
    ...
    taskPoolLineBody: "Available tasks and earnings vary. Device earnings may decline over time.",
    capExplainTitle: "Task capacity & the new-device subsidy",
    capExplainS1Title: "Why the task pool keeps upgrading",
    capExplainS1Body: "Tasks and earnings vary, and device earnings may decline over time. Check your earnings records for actual amounts.",
    ...
    hashTier: "Tier {n}",
    hashOutput: "{n}% output",
    hashFactorPeak: "Peak · online",
    hashFactorContinuity: "Stability bonus building",
    hashFactorBattery: "Low battery · paused",
  ...
  genesisHolder: {
    ...
    pre: {
      ...
      serverVerified: "Confirmed",
      remainingUnit: "seats remaining",
      serverPointsUnavailable: "Rankings are unavailable. Please try again later.",
    ...
    post: {
      ...
      noEmissions: "No distribution records yet",
  ...
  preferences: {
    ...
    hapticsHint: "Vibrate on confirmation, where supported.",
    ...
    notifFooter: "Notification settings apply to messages and Nova alerts.",
  },
  ...
  entrySurface: {
    ...
    indexNavSubtitle: "Choose an entry",
    indexEyebrow: "Three entry surfaces",
    indexTitle: "Choose how to access UVEL",
    indexBody: "Access UVEL through the app, a browser or your device check.",
    fullLinks: "View other ways to access UVEL",
    surfaces: {
      signed: {
        linkLabel: "App home",
        kicker: "UVEL App",
        ...
        steps: {
          ...
          b: { title: "Keep online", body: "Keep your device online to view its current status." },
      ...
      h5: {
        ...
        steps: {
          ...
          b: { title: "Register device", body: "View the devices linked to your account." },
          c: { title: "Upgrade path", body: "Installed app stays visible; PC sharing appears when it is available." },
        },
      },
      white: {
        linkLabel: "Device check home",
        kicker: "Device check",
        title: "Health scan into UVEL home",
        body: "View your hardware score, account balance and device status, then continue to UVEL.",
        ...
        metrics: {
          ...
          b: { label: "Fleet status", value: "Available" },
          c: { label: "App access", value: "Ready" },
        },
        steps: {
          a: { title: "Check your device", body: "View your device check results." },
          b: { title: "Read account", body: "View your account balance and devices." },
          c: { title: "Move onward", body: "Continue to the store, earnings, team and wallet." },
        },
      },
    },
  },
  ...
  search: {
    ...
    emptyBody: "Search pages, devices, products, members and help.",
    noResults: "No results — try different keywords.",
    askNova: "Ask Nova",
    askNovaWithQuery: "Ask Nova about “{query}”",
    groupLabels: {
      route: "Pages",
      device: "Your devices",
    ...
    faqEntries: {
      royalty: { label: "About network rewards", sub: "Reward details and payment history" },
      ...
      nex: { label: "NEX token explained", sub: "Uses and risks" },
    },
  },
  ...
  goals: {
    ...
    heroSubtitle: "Choose a goal and device model to view estimated progress.",
  ...
  tx: {
    ...
    footer: "All UVEL transactions settle on their native network with batch finality.",
    detailUnavailableTitle: "On-chain details unavailable",
    detailUnavailableBody: "On-chain details are unavailable. Your transaction hash is retained; check the bill for its status.",
  },
  ...
  riskDisclosure: {
    ...
    s2Title: "Tasks and device earnings may decline",
    s2Body: "Tasks and earnings for the same device may decline substantially over time. New-device bonuses are time-limited; earnings may fall when they end. Trade-in credit may also change. Check the current quote before confirming; credit applies only to that purchase and cannot be withdrawn.",
    ...
    s4Body: "Check the order status for withdrawal progress. Each withdrawal has a fixed network confirmation fee that does not vary with the amount; some networks may be free. You may choose to cover this fee with NEX. This option is off by default and uses no NEX unless enabled. Earn NEX through check-ins, compute tasks or referral activities.",
    ...
    s6Body: "Referral rewards depend on qualifying activity records and are not guaranteed earnings. Refunds or disputes may adjust rewards. Abusive referrals may lead to reward cancellation or account suspension.",
    ...
    acceptToast: "Risk disclosure acknowledged",
    ...
    gateUnavailable: "Unable to confirm your acknowledgment. Nothing was submitted; please try again later.",
  },
  ...
  milestones: {
    ...
    earn100: "Total earnings have reached $100.",
    earn500: "Total earnings have reached $500.",
  ...
  tradein: {
    ...
    retireSubtitle: "Choose an upgrade for {name} and review the current trade-in quote.",
    ...
    remoteQuoteCreditLabel: "Current trade-in credit",
    remoteQuoteBandLabel: "Current quote",
    sheetCreditLabel: "Credit",
    sheetNetCostLabel: "Est. payable",
    sheetCta: "Confirm · checkout ${amount}",
    sheetCancel: "Cancel",
    sheetDisclaimer: "Continue to checkout to pay. After payment, the old device stops taking tasks and is removed from your devices. Credit applies only to this purchase, is not added to your balance and cannot be withdrawn. Review the credit and amount due.",
    // Checkout credit row
    ...
    ladderTitle: "About trade-ins",
    ladderIntro: "Choose an upgrade to view the current credit and amount due on the confirmation screen.",
  ...
  tickets: {
    ...
    note: "Tickets are private 1:1 with our support team. For general questions, use in-app messages.",
  ...
  events: {
    ...
    loadErrorTitle: "Events are temporarily unavailable",
    loadErrorBody: "Events could not be loaded. Please try again later.",
    retry: "Retry",
    empty: {
  ...
  trial: {
    ...
    claimUnknownInline: "The claim result is not confirmed. Refresh to check before retrying.",
    ...
    eligReasonUnknown: "Unable to confirm trial availability. Check your connection and retry.",
  ...
  novaCard: {
    ...
    messageWithPercent: "Check your device status and product details. Ask Nova if you need help.",
  ...
  myDevices: {
    ...
    inventoryRemoteWaitUnavailable: "Unable to stop automatically after the task. Retry later or choose Stop now.",
  ...
  deactivateSheet: {
    ...
    toastSubmitting: "Submitting auto-deactivation…",
  ...
  computeShare: {
    ...
    demoBody: "Choose a graphics card model. Your computer will appear in Devices after connecting.",
    ...
    pairingPending: "Enter this six-digit code in the UVEL desktop app signed into the same account, then wait for connection.",
  ...
  store: {
    ...
    catalogLoadingBody: "Loading products and current prices…",
    ...
    catalogEmptyBody: "No devices are available for purchase. Please check back later.",
    ...
    coAwaitingServer: "Order created. Confirming payment and device activation.",
    coServerStatus: "Order status",
    ...
    pendingBarLabel: "Awaiting payment",
    pendingBarResume: "Continue →",
    pendingKeptToast: "Order held for {min} min — continue anytime from the bar at the top",
    pendingExpiredTitle: "Payment window closed",
    pendingExpiredBody: "This address is no longer valid. Start again to get a fresh one.",
    pendingStartAgain: "Start again",
    pendingCollisionTitle: "You have an unpaid order",
    pendingCollisionBody: "{name} · ${amount} is still waiting for payment ({left} left). Drop it and start this one? If you already sent funds to its address, keep it — you can resume it anytime from the bar at the top.",
    pendingCollisionKeep: "Keep it",
    pendingCollisionDrop: "Drop it, start new",
    pendingCancelTitle: "Have you already sent the funds?",
    pendingCancelBody: "If you already sent USDT to this address, do NOT cancel — the order would stop waiting for it and the transfer can't be matched automatically. Tap “I've completed the payment” instead. If you haven't sent anything yet, it's safe to cancel.",
    pendingCancelConfirm: "Cancel payment",
    pendingCancelKeep: "Sent — keep paying",
    pendingCancelledToast: "Payment cancelled — the order is no longer waiting for funds.",
    ...
    tradeinUpgrade: {
      ...
      body: "Upgrading to {target} is estimated to cost ${net}. Review the current quote before confirming.",
      cta: "View my devices",
    },
    ...
    gateProgress: "Currently unavailable",
    gateLockedCta: "View availability",
    ...
    purchaseEligibilityLoading: "Checking purchase eligibility…",
    purchaseEligibilityIneligible: "Not eligible to purchase",
    purchaseEligibilityError: "We couldn't verify purchase eligibility",
    purchaseEligibilityFailClosed: "Unable to confirm purchase availability. Please retry.",
    purchaseEligibilityRetry: "Retry eligibility check",
    ...
    releasePhaseRef: "E1 phase {phase}",
    releasePhasePending: "This product is not on sale yet.",
    releaseSchedulePending: "This product is not on sale yet.",
    releaseEligibilityPending: "This generation is not yet eligible for release.",
    releaseRhythmUnavailable: "The platform release rhythm is temporarily unavailable.",
    releaseConfigUnavailable: "Product information is unavailable. Please retry later.",
    releasePending: "This product is currently unavailable.",
    lockedUnlockProgress: "unlock progress",
    lockedInQueue: "in queue",
    comingSoonNote: "More models coming soon",
    ordersChip: "Orders",
  ...
  team: {
    ...
    serverRewardPerSettlement: "Invitation reward",
  ...
  wallet: {
    ...
    syncFailedBody: "Earnings have not synced yet. Updates will resume when available; existing earnings are unaffected.",
    ...
    fastLaneOnBody: "Check the amount and recipient address before submitting.",
    ...
    trackConfirmArrivalFailed: "Unable to confirm receipt. Refresh and retry later.",
    trackEtaPending: "Expected within {n} hours",
    trackExpectedAt: "Expected processing time {time}",
    ...
    withdrawRouteReviewBody: "This withdrawal needs a security review before processing can continue.",
  ...
  onboarding: {
    ...
    calibrationSubtitle: "View your estimated score after calibration.",
    calibrationWhyTitle: "How we assess",
    calibrationWhyLine1: "Device details, including model and memory, provide an estimated capability score.",
    ...
    policyLine2: "Stay connected via Wi-Fi or mobile data.",
    policyLine3: "Tasks may pause or be cancelled if disconnected. Keep your device online.",
    ...
    recalSubtitle: "New device detected — estimating capability from this phone's details.",
  ...
  nova: {
    ...
    localConnecting: "Connecting to Nova…",
    localUnavailable: "Nova is unavailable. Please try again later.",
    localRetry: "Retry",
    localFailed: "Unable to get a reply. No account actions were performed.",
    ...
    push: {
      ...
      teamPlacedOne: "One member joined your team. View the updated member list.",
      teamPlacedMany: "{n} members joined your team. View the updated member list.",
      teamPlacedCta: "See Balance Match",
      teamRankGap: "Your level status has updated. Check your Team page.",
      teamRankGapCta: "Boost team",
      teamPeerBonus: "New reward +${amt}. Check your credited records.",
      teamPeerBonusCta: "Open",
      stakingApyUp: "⚡ 180-day vault APY just rose from 80% → 95% (24h window only).",
      stakingApyUpCta: "Lock now",
      stakingGenesisLow: "Check Genesis availability and purchase details.",
      stakingGenesisLowCta: "Claim seat",
      stakingLockNow: "Review the terms, earnings and risks of current staking plans.",
      stakingLockNowCta: "Lock 180d",
      stakingMatures: "After maturity, claim from the Staking page. Check your current status.",
      stakingMaturesCta: "Manage",
      marketPriceBreak: "📈 $NEX just broke ${price} · +{change}% in 24h · new ATH this week.",
      marketPriceBreakCta: "Buy NEX",
      marketTvl: "Platform data has updated. View the latest information.",
    ...
    reply: {
      ...
      todayBody:
        "Today, {devices} earned ${amount}.\n\n{topLine}\n\nOpen earnings records for details.",
      boostLocked:
        "Check that your device is online with sufficient battery and a working connection. View tasks and actual earnings on the device page; earnings vary with available tasks.",
      boostMaxed:
        "Review the status and actual earnings of your devices before choosing any additional device. Earnings are not guaranteed.",
      hotLlm:
      ...
      hotFineTune:
        "View the latest {pool} information on the Market page. Check device records for actual tasks and earnings.",
      topJobsOpen:
      ...
      topJobsLocked:
        "Some tasks may be incompatible with your device. Check compatibility and actual task records on the device page.",
  ...
  profile: {
    ...
    serverMutationFailed: "Unable to confirm your profile. Refresh and try again.",
  ...
  security: {
    ...
    mockModeLabel: "Demo mode · Preview only",
    twoFactorCodeInvalid: "That verification code is invalid or expired.",
    ...
    deleteAccountHint:
      "Account deletion requests require review. Financial and security records required by law will not be deleted immediately.", // anxiety-exempt: 注销为破坏性流程,刻意摩擦+审计要求诚实披露
    deleteAccountPending: "Your deletion request is under review. Please do not submit it again.", // anxiety-exempt: 注销为破坏性流程,刻意摩擦+审计要求诚实披露
    deleteAccountConfirm:
      "Submit a request to delete your UVEL account?\n\nYou will be signed out. Check the deletion request for its result.",
    ...
    deleteAccountUnavailable: "Unable to confirm the deletion result. Check again later or contact support.",
    cancelDeletionRequest: "Cancel deletion request",
    cancelDeletionMessage: "This cancels the current request only. You can submit a new request later.",
    cancelDeletionSuccess: "Deletion request cancelled",
    deleteAccountBlocked: "Deletion blocked: {reason}",
  ...
  help: {
    ...
    contactSupport: "Contact support",
    contactHint: "Use in-app messages or open a ticket",
  ...
  conversations: {
    ...
    advisorReply2: "You can review each model’s specifications, price and current availability.",
  ...
  exchange: {
    ...
    cancelQueued: "Cancel queued order",
    cancelling: "Cancelling…",
    cancelDone: "Queued swap cancelled",
    cancelDoneBody: "The swap did not execute and your balances are unchanged.",
    cancelNotAllowed: "This order is already processing or finished and cannot be cancelled. Refresh to see its latest status.",
    cancelUnknownTitle: "Cancellation not confirmed",
    cancelUnknownBody: "Cancellation is not confirmed. Refresh to check or retry later.",
    platformExhaustedTitle: "Today's limit is full",
    platformExhaustedBody: "Exchange is currently unavailable. Please try again later; this trade was not completed.",
    ...
    swapPlatformCapReason: "Exchange is unavailable today. This trade was not completed.",
    swapGeoBlockedReason: "This exchange is unavailable in your region.",
    swapNotFilled: "Exchange was not completed. Check your history.",
    accountSwitchedRefreshed: "Account switched. Current account data has been refreshed.",
  ...
  exchangeHowItWorks: {
    ...
    s3Intro:
      "Your available exchange amount is shown on the exchange page.",
    lim1Label: "Per-user daily cap · $50/day",
    lim1Body:
      "Check your available amount and reset time on the exchange page.",
    ...
    faqA4:
      "Check your available limit and exchange history. Pending requests can be cancelled before processing.",
  ...
  orders: {
    ...
    refreshFailed: "We couldn't load the latest order status. Retry before acting.",
  },
  staking: {
    title: "Staking",
    back: "Back",
  ...
  achievements: {
    ...
    remoteLoading: "Loading achievements…",
    remoteUnavailable: "Achievements are unavailable. Please retry.",
    retry: "Reload",
    ...
    a_first_contribution_d: "Activate phone compute",
  ...
  globe: {
    ...
    regionProjectionLoadingDesc: "Loading online nodes and task distribution.",
    regionProjectionEmptyTitle: "No regional nodes yet",
    regionProjectionEmptyDesc: "No online node information is available.",
    regionProjectionErrorTitle: "Regional network unavailable",
    regionProjectionErrorDesc: "Regional data is unavailable. Check your connection and retry.",
    regionLatencyUnavailable: "Avg latency {n}",
    metricUnavailable: "--",
    projectionUpdatedAt: "Updated {at}",
    uptimeLine: "uptime {v}",
  },
  proof: {
    ...
    posterHintTitle: "Tip",
    posterHint:
      "Share your contribution card to show friends your progress.",
    // Enhanced share hub
  ...
  errors: {
    ...
    payoutStuckTitle: "Trial earnings not credited",
    payoutStuckMsg: "Your order went through, but the trial earnings due to you could not be credited. Contact support with reference {id}.",
  ...
  teamV3: {
    ...
    quotaSubtitle: "View device availability",
    ambassador: "Ambassador",
    ambassadorSubtitle: "Applications and status",
    visualizations: {
      influenceNetwork: "Influence Network",
      orbitLiveMap: "View members",
      genealogy: "Genealogy",
      genealogySubtitle: "View team members",
    },
    leaderboardCard: {
      title: "Top Inviters",
  ...
  stakingHowItWorks: {
    ...
    heroTitle: "Review the term, earnings and redemption conditions.",
    heroSub:
      "Check the lock period and fees before confirming. Early redemption may result in losses.",
    ...
    s3Step3Title: "Claim at maturity",
    s3Step3Body:
      "At maturity, view the claimable amount in Positions. Claim it to move principal and interest to your wallet.",
    ...
    faqA1:
      "The minimum is 20 USDT per position. Check the current requirement before confirming.",
    ...
    faqQ3: "What if I have not claimed at maturity?",
    faqA3:
      "A matured position remains available to claim and no longer earns interest. View and claim it in Positions.",
    faqQ4: "Can I have multiple positions at once?",
    faqA4:
      "Yes. Each position shows its own amount, term and maturity date.",
  ...
  trust: {
    ...
    nexAnchorSubhero: "Explore NEX uses, current quotes and price risks",
    ...
    errorOffline: "Public information is unavailable. Please try again later.",
    errorGeoUnresolved: "We can't confirm which rules apply in your region right now — check your connection and retry.",
    errorUnavailable: "Public information is unavailable. Please try again later.",
  },

  genesisEligibility: {
    title: "Subscription access",
    subtitlePolicy: "View your current purchase availability.",
    accountAgeRule: "Minimum account age",
    holdingCapRule: "Per-account holding cap",
    daysUnit: "days",
    reasonPolicyUnavailable: "Unable to confirm purchase availability. Please retry later.",
    reasonAccountAge: "Purchase is not yet available for this account. Please try again later.",
    reasonCountry: "Add the account country or region first.",
    reasonGeoBlocked: "Subscription is unavailable in the current country or region.",
    reasonPresaleClosed: "Subscription is not open at this time.",
    reasonCapReached: "This account has reached its holding cap.",
    reasonMarketDisabled: "Genesis Node trading is not open.",
    reasonUnavailable: "This account does not currently meet the subscription policy.",
    ...
    cardLockedLine: "Purchase currently unavailable",
    cardPolicyManaged: "View details",
    cardCta: "Subscribe now",
    cardCtaLocked: "View requirements",
    toastIneligible: "Subscription access required",
    toastIneligibleSub: "Purchase is currently unavailable. View details or contact support.",
  ...
  genesis: {
    ...
    purchaseUnavailable: "Unable to connect. Please retry later.",
  ...
  walletV3: {
    ...
    withdrawAmbiguousExitTitle: "The previous withdrawal is still uncertain",
    withdrawAmbiguousExitBody: "Check the previous withdrawal result first. If submitted, the existing order will open to avoid a duplicate.",
    withdrawAbandonAttemptCta: "Verify and abandon",
    withdrawAbandonAttemptTitle: "Abandon this unconfirmed attempt?",
    withdrawAbandonAttemptBody: "We will check whether it was submitted. Only an unsubmitted request will be cancelled; existing orders are not cancelled or charged again.",
    withdrawAbandonSuccess: "The unconfirmed attempt was closed without another submission.",
    withdrawAbandonAlreadyCommitted: "Withdrawal submitted. Opening the existing order.",
    ...
    withdrawNotSentBody:
      "Your device could not save the withdrawal request. Nothing was submitted and your balance is unchanged. Free some space or reopen the app and retry.",
  ...
  unilevel: {
    serverRewardHold: "Reward records are unavailable. Please try again later.",
    pageTitle: "Influence Network Royalty",
    pageSubtitle: "View royalty earnings and credited records.",
    people: "people",
  ...
  repurchaseHowItWorks: {
    ...
    heroSub:
      "Review the lock period, estimated earnings and early exit fees before confirming.",
    ...
    s1Para2:
      "Estimated earnings are not guaranteed. Refer to the confirmation page and actual records.",
    ...
    benefit4Body:
      "Eligible cultivation rewards receive a ×1.5 boost during the 90-day lock period.",
    ...
    faqA1:
      "Both require a lock period. Compare terms, earnings, added benefits and early exit fees on the confirmation page.",
  ...
  network: {
    ...
    projectionErrorDesc: "Team data could not be loaded. Please retry.",
    retry: "Retry",
    diagramYou: "YOU",
  },
  ...
  tree: {
    ...
    serverVolumeSubtitle: "{n} members · Volume ${volume}",
    badgeDirect: "DIRECT",
    badgeExtended: "EXT",
  ...
  quota: {
    ...
    buyCta: "Buy {name}",
    inviteToUnlock: "Contact support",
  ...
  agent: {
    ...
    heroBody:
      "Regional ambassadors can apply for event and promotion support. Check application results here.",
    eligible: "Eligible",
    ...
    lockedV5: "Applications unavailable",
    previewOnly: "Applications are currently unavailable. Contact support for an update.",
    recentlyApproved: "Recently approved",
    hostedBy: "Hosted by {name} · {attendees} attendees",
    toastV5Required: "Applications unavailable",
    toastV5RequiredSub: "Contact support to check application availability.",
    ...
    serverApplication: "My application",
  ...
  marketplace: {
    ...
    royaltyFooter: "A 2.5% royalty applies on sale. Check the net proceeds before confirming.",
    ...
    listToastSub: "Price ${price} · View listing status",
  },
  ...
  genesisHowItWorks: {
    ...
    s3Step1Body:
      "Review the current price, quantity and availability on the purchase page. Pay with USDT.",
  ...
  nexHowItWorks: {
    ...
    src3Body:
      "Check the task pages for check-in and event rewards. Actual amounts appear in your records.",
    ...
    use1Body:
      "Exchange NEX for USDT in your wallet, then follow the withdrawal instructions.",
    ...
    use3Body:
      "You can choose to offset withdrawal fees with NEX. Check the NEX amount and final fee before confirming.",
    use4Label: "Hold for long-term appreciation",
    use4Body:
      "NEX prices may rise or fall. Value preservation and profit are not guaranteed.",
    s4Title: "Why does the price move?",
    s4Intro:
      "NEX prices fluctuate. Review the following before holding or exchanging.",
    s4DemandLabel: "Current quote",
    s4DemandBody:
      "Quotes can change. Check the price, fees and expected amount on the confirmation screen before exchanging.",
    s4BurnLabel: "Price risk",
    s4BurnBody:
      "Prices may rise or fall. There is no guarantee of preserving value or earning a profit; your holdings may lose value.",
    s4HintTitle: "Track NEX in real time",
    s4HintBody:
      "View market information in the Trust Center. Past performance does not predict future results.",
    faqTitle: "Common questions",
  ...
  missions: {
    ...
    eventsUnavailableTitle: "Events are temporarily unavailable",
    eventsUnavailableBody: "Events could not be loaded. Please retry.",
    retry: "Retry",
  ...
  weeklyQuest: {
    ...
    loading: "Loading weekly quests…",
    loadError: "Weekly quests are unavailable · tap to retry",
    empty: "No weekly quests available",
    progressVerified: "Confirming task progress.",
    ...
    tier1_nex_v2_lock_body: "Review the returns and risks of the current 365-day staking plan. Claim from the Staking page after maturity.",
    ...
    tier1_buy_first_box_title: "Buy your first UVELBox",
    tier1_buy_first_box_body: "Review UVELBox S1 specifications, pricing and purchase information.",
  ...
  quest: {
    ...
    t_view_product_roi: "View product details",
  ...
  share: {
    ...
    linkUnavailable: "Invite link unavailable until an official link is configured",
  ...
  bankPane: {
    ...
    feeConfigured: "Fee {usdt} USDT",
    feeConfiguredVnd: "Fee {usdt} USDT · {vnd}",
    ...
    manualStep1: "Open your bank app and transfer {amount} to {account}",
  ...
  addrRebind: {
    ...
    cancelCta: "Cancel",
    reasonNewAddressAge: "This withdrawal requires a security review.",
  ...
  learning: {
    ...
    centerOffline: "Tutorials are unavailable. Please retry later.",
    centerGeoUnresolved: "Unable to confirm courses available in your region. Check your connection and retry.",
    centerUnavailable: "The learning center is unavailable right now; please retry shortly.",
    courseLoading: "Loading the course…",
    courseVersionMeta: "Reward {nex} NEX",
    courseOffline: "This course is unavailable. Return to Tutorials and retry.",
    ...
    submitUnconfirmed: "The submission result is not confirmed. Refresh your progress to check.",
  },
};
