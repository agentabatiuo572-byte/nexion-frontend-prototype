...
export const en = {
  ...
  home: {
    ...
    productTrustSubtitle: "Available device · admin catalog data",
    productTrustGpu: "GPU",
    productTrustDatacenter: "Managed at",
    productTrustWarranty: "Warranty",
    productTrustUnavailable: "Not configured",
  ...
  events: {
    ...
    loadErrorBody: "The server did not return the event list. Nothing is being inferred locally; retry when the connection is back.",
    retry: "Retry",
    empty: {
  ...
  store: {
    ...
    coSandboxWallet: "Sandbox wallet",
    coHintSandboxWallet: "Simulated settlement · no real funds",
    ...
    purchaseEligibilityFailClosed: "Nothing is confirmed until the server decision loads. Retry to check again.",
    ...
    releasePhasePending: "The server release schedule has not reached {phase}.",
    releaseSchedulePending: "The server release month has not been reached.",
    ...
    releaseConfigUnavailable: "The server release configuration is temporarily unavailable.",
    releasePending: "This product is waiting for the server release decision.",
  ...
  onboarding: {
    ...
    policyLine3: "Brief interruptions keep the task; timeouts replace it.",
  ...
  security: {
    ...
    mockModeLabel: "Local mock authentication · no remote service",
  ...
  exchange: {
    ...
    cancelUnknownBody: "We refreshed the authoritative status. If the order is still queued, try again shortly; the same request number will be reused.",
  ...
  orders: {
    ...
    sandboxPayCta: "SANDBOX · Continue simulated payment",
    sandboxPayBusy: "SANDBOX · Confirming payment…",
    sandboxPayHint: "Only available in the explicit local sandbox; the server receipt is read back before showing Paid.",
  ...
  genesisEligibility: {
    ...
    subtitlePolicy: "Access is determined by the current platform policy.",
    accountAgeRule: "Minimum account age",
    holdingCapRule: "Per-account holding cap",
    daysUnit: "days",
    reasonPolicyUnavailable: "The access policy is temporarily unavailable. Please try again later.",
    reasonAccountAge: "This account has not reached the current minimum age.",
    ...
    cardLockedLine: "Current platform policy is not met",
    cardPolicyManaged: "Admin managed",
    cardCta: "Subscribe now",
    cardCtaLocked: "View requirements",
    toastIneligible: "Subscription access required",
    toastIneligibleSub: "See the access page for the current policy and reason.",
  ...
  walletV3: {
    ...
    withdrawAmbiguousExitBody: "Retry the exact request, or ask the server to verify and abandon it. If an order exists, we will open it instead.",
    withdrawAbandonAttemptCta: "Verify and abandon",
    withdrawAbandonAttemptTitle: "Abandon this unconfirmed attempt?",
    withdrawAbandonAttemptBody: "The server checks for an existing order first. It closes only an uncommitted attempt and never cancels or duplicates a committed withdrawal.",
    withdrawAbandonSuccess: "The unconfirmed attempt was closed without another submission.",
    withdrawAbandonAlreadyCommitted: "This withdrawal was already submitted. Opening the server order.",
  ...
  genesisHowItWorks: {
    ...
    s1Access:
      "Qualification is set by one admin policy: the eligibility switch, per-user holding cap, and minimum account age. Deposits, devices, team rank, and invite codes no longer qualify a Genesis purchase.",
  ...
  missions: {
    ...
    eventsUnavailableBody: "The server did not return the event summary. Retry to load it again.",
    retry: "Retry",
  ...
  weeklyQuest: {
    ...
    progressVerified: "Progress is verified by the server.",
  ...
  addrRebind: {
    ...
    sandboxMockNotice: "Sandbox acceptance data · addresses, SMS codes, and security freezes are local mocks and never initiate a real on-chain transfer.",
    manageCta: "Manage",
