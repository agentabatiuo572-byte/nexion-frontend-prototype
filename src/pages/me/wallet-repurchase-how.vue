<!--
  Re-invest · How it works — explainer (ported from
  Nexion-prototype/app/(main)/me/wallet/repurchase/how-it-works/page.tsx).
  Reuses shared how-* components. lemon accent.
-->
<template>
