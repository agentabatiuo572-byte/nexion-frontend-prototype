...
export function parseProofSnapshot(value: unknown, mode: ApiResponseEnvironment = "prod"): ProofSnapshot {
...
export function createProofApi(client: ApiClient, mode: ApiResponseEnvironment = "prod") {
